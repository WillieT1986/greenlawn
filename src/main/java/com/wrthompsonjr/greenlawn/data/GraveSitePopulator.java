...
public class GraveSitePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Jody A Gotyou", "State",
				"Military Rank", "Military Branch", "Military Unit", "1895", "1920", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagOne));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Jody B GotMe", "State",
				"Military Rank", "Military Branch", "Military Unit", "1910", "1944", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Johnny C Oorah", "State",
				"Military Rank", "Military Branch", "Military Unit", "1874", "1957", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagThree));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Johnny D Hoohah", "State",
				"Military Rank", "Military Branch", "Military Unit", "1891", "1955", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagOne, tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Johnny E Schmukatelli", "State",
				"Military Rank", "Military Branch", "Military Unit", "1921", "1955", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Jane A Dane", "State", "Military Rank",
				"Military Branch", "Military Unit", "1900", "1950", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Jane B Dane", "State", "Military Rank",
				"Military Branch", "Military Unit", "1900", "1944", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Barbie C Oorah", "State",
				"Military Rank", "Military Branch", "Military Unit", "1895", "1957", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Barbie D Hoohah", "State",
				"Military Rank", "Military Branch", "Military Unit", "1901", "1955", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagTwo));
		graveSiteRepo.save(new GraveSite("./images/tombstone/place-holder.jpg", "Barbie E Schmukatelli", "State",
				"Military Rank", "Military Branch", "Military Unit", "1921", "1955", "Veteran",
				"No Summary At This Time...", sectionB, "Religion", tagTwo));
	}
}