...
public class PersonPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// 10 sample Military
		personRepo.save(new Person("tombstoneImageUrl", "Jody A Gotyou", "State", "Military Rank", "1895", "1920",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagOne));
		personRepo.save(new Person("tombstoneImageUrl", "Jody B GotMe", "State", "Military Rank", "1910", "1944",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Johnny C Oorah", "State", "Military Rank", "1874", "1957",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagThree));
		personRepo.save(new Person("tombstoneImageUrl", "Johnny D Hoohah", "State", "Military Rank", "1891", "1955",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagOne, tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Johnny E Schmukatelli", "State", "Military Rank", "1921",
				"1955", "Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Jane A Dane", "State", "Military Rank", "1900", "1950",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Jane B Dane", "State", "Military Rank", "1900", "1944",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Barbie C Oorah", "State", "Military Rank", "1895", "1957",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Barbie D Hoohah", "State", "Military Rank", "1901", "1955",
				"Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
		personRepo.save(new Person("tombstoneImageUrl", "Barbie E Schmukatelli", "State", "Military Rank", "1921",
				"1955", "Veteran", "No Summary At This Time...", sectionB, "Religion", tagTwo));
	}
}