...
public class PersonPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// 10 sample Military
		personRepo.save(new Person("Jody A Gotyou", "1895", "1920", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagOne));
		personRepo.save(new Person("Jody B GotMe", "1910", "1944", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		...
		personRepo.save(new Person("Jane A Dane", "1900", "1950", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		personRepo.save(new Person("Jane B Dane", "1900", "1944", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		personRepo.save(new Person("Barbie C Oorah", "1895", "1957", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		personRepo.save(new Person("Barbie D Hoohah", "1901", "1955", "Veteran", "No Summary At This Time...", sectionB,
				"Religion", tagTwo));
		personRepo.save(new Person("Barbie E Schmukatelli", "1921", "1955", "Veteran", "No Summary At This Time...",
				sectionB, "Religion", tagTwo));
	}
}