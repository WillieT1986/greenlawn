...
public class JpaMappingTest {
	...
	public void shouldSaveAndLoadPerson() {
		Person person = new Person("tombstoneImageUrl", "personName", "State", "DateOfBirth", "DateOfDeath", "Status",
				"Description", null, "");
	...
	public void shouldSavePersonToSectionRelationship() {
		...
		Person firstPerson = new Person("tombstoneImageUrl", "personName", "State", "DateOfBirth", "DateOfDeath",
				"Status", "Description", section, "");
		firstPerson = personRepo.save(firstPerson);

		Person secondPerson = new Person("tombstoneImageUrl", "personName", "State", "DateOfBirth", "DateOfDeath",
				"Status", "Description", section, "");
	...
	public void shouldEstablishPersonToTagRelationship() {
		...
		Person person = new Person("tombstoneImageUrl", "personName", "State", "DateOfBirth", "DateOfDeath", "Status",
				"Description", null, "Religion", veteran, electedOfficial);
		person = personRepo.save(person);
	...
	public void shouldEstablishTagToPersonRelationship() {
		...
		Person firstPerson = new Person("tombstoneImageUrl", "personName", "State", "DateOfBirth", "DateOfDeath",
				"Status", "Description", null, "Religion", tag);
		firstPerson = personRepo.save(firstPerson);
	...
	public void shouldReturnPersonNameDateOfBirthDateOfDeathStatusAndDescription() {
		...
		Person underTest = new Person("tombstoneImageUrl", "personName", "State", "DateOfBirth", "DateOfDeath",
				"Status", "Description", null, "Religion", tag);
